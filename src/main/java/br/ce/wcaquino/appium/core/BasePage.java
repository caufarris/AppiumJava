...
public class BasePage {
	...
	public boolean isCheckMarcado(By by) {
		return getDriver().findElement(by).getAttribute("checked").contentEquals("true");
	}
	...
	public void swipe(double inicio, double fim) {
		...
		int start_x = (int) (size.height * inicio);
		int end_x = (int) (size.height * fim);
	...
	public void swipeElement(MobileElement element, double inicio, double fim) {
		...
		int end_x = (int) (element.getSize().height * fim);
